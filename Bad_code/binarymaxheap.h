...
namespace ip2
{
    ...
    public:
        ...
        bool operator<(const MaxHeap& other) const;     //Checks if left heap is a subset of the right one
        bool operator>(const MaxHeap& other) const;     //Checks if right heap is a subset of the left one
        bool operator<=(const MaxHeap& other) const;    //Checks if left heap is identical to or a subset of the right one
        bool operator>=(const MaxHeap& other) const;    //Checks if right heap is identical to or a subset of the left one
